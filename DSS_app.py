...
query_brand = st.query_params.get("brand", None)
current_page = query_brand if query_brand in BRAND_CONFIG else "home"
...
if current_page == "home":
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    __BRAND_CARDS__
            ...
            <div class="deep-dive-section" id="deep-dive-section" style="display:none;">
                ...
                <div class="deep-dive-grid">
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=nurtec'"><div class="tile-name">Nurtec</div></div>
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=eliquis'"><div class="tile-name">Eliquis</div></div>
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=prevnar'"><div class="tile-name">Prevnar</div></div>
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=comirnaty'"><div class="tile-name">Comirnaty</div></div>
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=abrysvo'"><div class="tile-name">Abrysvo</div></div>
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=paxlovid'"><div class="tile-name">Paxlovid</div></div>
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=zavzpret'"><div class="tile-name">Zavzpret</div></div>
                    <div class="deep-dive-tile" onclick="window.parent.location.search='?brand=beyfortus'"><div class="tile-name">Beyfortus</div></div>
                </div>
            </div>
        </main>
    </div>
    ...
    # ===========================================================
    # BRAND DEEP DIVE PAGE
    # ===========================================================
    from brand_pages import render_brand_page
    render_brand_page(current_page, BRAND_CONFIG)
